...
public class ClientMapper {
    ...
    public static ClientDto toDto(Client entity) {
    	ClientDto dto = new ClientDto(entity.getClientId(), entity.getFirstName(), entity.getLastName(), entity.getEmail(), entity.getCreationDate(), entity.getAvailable());
        return dto;
    }

    public static Client toEntity(ClientDto dto) {
    	Client entity = new Client(dto.getClientId(), dto.getFirstName(), dto.getLastName(), dto.getEmail(), dto.getCreationDate(), dto.getAvailable());
        return entity;
    }
