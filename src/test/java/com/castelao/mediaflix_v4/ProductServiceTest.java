...
public class ProductServiceTest {
	...
	private Product createProduct(Long id, String title, Integer stock, String language, ProductType productType,
	...
	void testGetAllProducts() {
		List<Product> products = Arrays.asList(
				createProduct(1L, "Product 1", 10, "English", ProductType.BOOK, 10.0, 4.5, "url", "Fiction",
						Date.valueOf("2024-04-01"), true),
				createProduct(2L, "Product 2", 5, "Spanish", ProductType.BOOK, 20.0, 4.0, "url", "Non Fiction",
						Date.valueOf("2024-04-01"), true));
	...
	@Test
	void testFindById() {
		Product product = createProduct(1L, "Product 1", 10, "English", ProductType.BOOK, 10.0, 4.5, "url", "Fiction",
				Date.valueOf("2024-04-01"), true);
	...
	void testUpdate() {
		Product product = createProduct(1L, "Product 1", 10, "English", ProductType.BOOK, 10.0, 4.5, "url", "Fiction",
				Date.valueOf("2024-04-01"), true);
		ProductDto productDto = new ProductDto(1L, "Updated Product", "Updated Description", 15, "Spanish",
				ProductType.BOOK, 15.0, 4.8, "url", "Drama", Date.valueOf("2024-04-01"), true);
		...
		assertEquals("Updated Product", result.get().getTitle());
	}
	...
	void testSearchByGenre() {
		Page<Product> productPage = new PageImpl<>(Arrays.asList(createProduct(1L, "Product 1", 10, "English",
				ProductType.BOOK, 10.0, 4.5, "url", "Fiction", Date.valueOf("2024-04-01"), true)));
		...
		assertEquals("Product 1", result.getProducts().get(0).getTitle());
	}
	...
	void testSearchByProductType() {
		Page<Product> productPage = new PageImpl<>(Arrays.asList(createProduct(1L, "Product 1", 10, "English",
				ProductType.BOOK, 10.0, 4.5, "url", "Fiction", Date.valueOf("2024-04-01"), true)));
		when(productRepository.findByProductType(any(ProductType.class), any(PageRequest.class)))
	...
	void testSearchByPrice() {
		Page<Product> productPage = new PageImpl<>(Arrays.asList(createProduct(1L, "Product 1", 10, "English",
				ProductType.BOOK, 10.0, 4.5, "url", "Fiction", Date.valueOf("2024-04-01"), true)));
		when(productRepository.findByPriceGreaterThanEqual(any(BigDecimal.class), any(PageRequest.class)))
				.thenReturn(productPage);
	...
	void testSearchByNotAvailable() {
		Page<Product> productPage = new PageImpl<>(Arrays.asList(createProduct(1L, "Product 1", 10, "English",
				ProductType.BOOK, 10.0, 4.5, "url", "Fiction", Date.valueOf("2024-04-01"), false)));
	...
	void testSearchByTitleWithoutPagination() {
		List<Product> products = Arrays.asList(createProduct(1L, "Product 1", 10, "English", ProductType.BOOK, 10.0,
				4.5, "url", "Fiction", Date.valueOf("2024-04-01"), true));
	...
	void testSearchByRating() {
		Page<Product> productPage = new PageImpl<>(Arrays.asList(createProduct(1L, "Product 1", 10, "English",
				ProductType.BOOK, 10.0, 4.5, "url", "Fiction", Date.valueOf("2024-04-01"), true)));
		when(productRepository.findByRatingGreaterThanEqual(any(BigDecimal.class), any(PageRequest.class)))
				.thenReturn(productPage);
	...
	void testSearchByStock() {
		Page<Product> productPage = new PageImpl<>(Arrays.asList(createProduct(1L, "Product 1", 10, "English",
				ProductType.BOOK, 10.0, 4.5, "url1", "Fiction", Date.valueOf("2023-01-01"), true)));
		when(productRepository.findByStockGreaterThanEqual(anyInt(), any(PageRequest.class))).thenReturn(productPage);

		ProductPageDto result = productService.searchByStock(10, 0, 10);
		assertNotNull(result);
		assertEquals(1, result.getProducts().size());
		assertEquals("Product 1", result.getProducts().get(0).getTitle());
	}
	...
	@Test
	void testFindAllProductsZeroStock() {
		List<Product> products = Arrays.asList(createProduct(1L, "Product 1", 0, "English", ProductType.BOOK, 10.0, 4.5,
				"url", "Fiction", Date.valueOf("2023-01-01"), true));
		when(productRepository.findAllProductsZeroStock()).thenReturn(products);

		List<Product> result = productService.findAllProductsZeroStock();
		assertNotNull(result);
		assertEquals(1, result.size());
		assertEquals("Product 1", result.get(0).getTitle());
	}
	...
	@Test
	void testFindAllProductsStockBetween1And5() {
		List<Product> products = Arrays.asList(createProduct(1L, "Product 1", 3, "English", ProductType.BOOK, 10.0, 4.5,
				"url", "Fiction", Date.valueOf("2023-01-01"), true));
		when(productRepository.findAllProductsStockBetween1And5()).thenReturn(products);

		List<Product> result = productService.findAllProductsStockBetween1And5();
		assertNotNull(result);
		assertEquals(1, result.size());
		assertEquals("Product 1", result.get(0).getTitle());
	}
